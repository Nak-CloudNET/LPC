                                                        ...
                                                        <?php } ?>                                                            
                                                                <li class="dropdown hidden-sm">
                                                                    ...
                                                                    <ul class="dropdown-menu pull-right">
																	 <li>
																		<? 
																			echo ($alertunifinished);
																			?>
                                                                            <a href="<?= site_url('jobs') ?>" class="">
                                                                                <span class="label label-danger pull-right" style="margin-top:3px;"><?= $alertunifinished ?></span>
                                                                                <span style="padding-right: 35px;"><?= lang('photo_still_not_complete') ?></span>
                                                                            </a>
                                                                      </li>
                            ...
                            ?>
								...
								<li class="mm_jobs">
                                    ...
                                    <ul>
										...
										<li id="jobs_commission">
                                            <a class="submenu" href="<?= site_url('jobs/commission'); ?>">
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('commission'); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>								
