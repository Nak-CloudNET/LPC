				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<?php
							...
							echo form_dropdown('marchine_name', $Marchine_name, $marchine_id, 'id="account_section" required="required" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("marchine"). '" style="width:100%;" ');
						?>
					</div>
				</div>
				<div class="col-md-6">
