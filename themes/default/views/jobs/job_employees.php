...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('jobs/getJobEmployees/'.$parent_id) ?>',
                    ...
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0" class="table table-condensed table-bordered table-hover table-striped">
                        <thead>
							<tr class="active">
								...
								<th class="col-xs-2"><?php echo $this->lang->line("កុំព្យូទ័រ "); ?></th>
								<th class="col-xs-2"><?php echo $this->lang->line("អ្នកកត់រូប"); ?></th>
