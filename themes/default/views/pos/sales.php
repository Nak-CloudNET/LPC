    ...
    $(document).ready(function () {
        var oTable = $('#POSData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, {"mRender": fld}/*null*/, null, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}, {"mRender": row_status}, {"mRender": row_status}, {"bSortable": false}],
			...
			{column_number: 10, filter_default_label: "[<?=lang('payment_status');?>]", filter_type: "select", data: [{ value: 'paid', label: '<?= lang('paid') ?>'},{ value: 'partial', label: '<?= lang('partial') ?>'},{ value: 'due', label: '<?= lang('due') ?>'}]},
			{column_number: 11, filter_default_label: "[<?=lang('develop_status');?>]", filter_type: "select", data: [{ value: 'completed', label: '<?= lang('completed') ?>'},{ value: 'processing', label: '<?= lang('processing') ?>'},{ value: 'pending', label: '<?= lang('pending') ?>'}]},
			{column_number: 12, filter_default_label: "[<?=lang('receive_status');?>]", filter_type: "select", data: [{ value: 'received', label: '<?= lang('received') ?>'},{ value: 'rec_partial', label: '<?= lang('rec_partial') ?>'},{ value: 'pending', label: '<?= lang('pending') ?>'}]},
		], "footer");
...
<?php if ($Owner) {
    echo form_open('pos/sales', 'id="action-form"');
} ?>
<div class="box">
                ...
                <div class="table-responsive">
                    <table id="POSData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
							...
							<th><?= lang("develop_status"); ?></th>
							<th><?= lang("receive_status"); ?></th>
