                        ...
                        <div id="print">
                            ...
                            <div id="left-bottom">
                                ...
                                <div id="botbuttons" style="text-align:center;">
									...
									<input type="hidden" name="date_receive" value="" class="date_receive">
									...
									<input type="hidden"  name="curr_payment"  id="curr_payment">
                    ...
                    <div class="col-md-10 col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <!--    <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
									<?= lang("date_receive", "date_receive"); ?> (yyyy-mm-dd)
									<?php echo form_input('date_receive', "", 'class="form-control input-tip datetime" id="date_receive"'); ?>
                                </div>
                            </div>	
                        </div>
						<div class="clearfix"></div>
                            ...
                            <div class="row">
								...
								<div class="col-sm-6">
									<div style="float:left;width:100%; margin-top: 30px;">
										<div class="form-group">
											<?= lang("curr_payment", "curr_payment"); ?>
											<input type="checkbox" name="ch_curr_payment" id="ch_curr_payment" value="1" style="margin-top:5px;">
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="col-md-12 col-sm-9" style="padding:0;">
								<div class="font16">
									<table class="table table-bordered table-condensed table-striped" style="font-size: 1.2em; font-weight: bold; margin-bottom: 0;">
										<tbody>
											<tr>
												<th width="50%" style="text-align:left;font-size:18px !important;"><?= lang("currency"); ?></th>
												<th  style="text-align:center;font-size:18px !important;"><?= lang("USD"); ?></th>
												<?php
													$this->db->select('*');
													...
													{
												?>
														<th  style="text-align:center;font-size:18px !important;"><?=$row->code?></th>
												<?php
													}
												?>
											</tr>
											<tr>
												<td width="50%" style="height: 50px;font-size:18px !important;"><?= lang("total_items"); ?></td>
												<td class="text-right" style="font-size:18px !important;"><span id="item_count">0.00</span></td>
												<?php
													foreach ($query as $row)
													{
												?>
														<td class="text-right" style="font-size:18px !important;"><span class="item_count">0.00</span></td>
												<?php
													}
												?>
											</tr>
											<tr>
												<td width="50%" style="height: 50px; font-size:18px !important;"><?= lang("total_payable"); ?></td>
												<td class="text-right" style="font-size:18px !important;"><span id="twt">0.00</span></td>
												<?php
													foreach ($query as $row)
													{
												?>
														<td class="text-right" style="font-size:18px !important;"><span class="curr_tpay" rate="<?=$row->rate?>" id="twt">0.00</span></td>
												<?php
													}
												?>
											</tr>
											<tr>
												<td width="50%" style="height: 50px;font-size:18px !important;"><?= lang("paid_amount"); ?></td>
												<td class="text-right"><input name="amount[]" type="text" id="amount_1" class="pa form-control input-lg kb-pad amount" style="text-align:right;font-size:18px !important;"/></td>
												<?php
													foreach ($query as $row)
													{
												?>
											...
											<tr>
												<td  rowspan="2" width="50%" style="height: 50px; text-align:left;font-size:18px !important;"><?= lang("remaining"); ?></td>
											...
											<tr>
												<td class="text-right" style="font-size:18px !important;"><span id="remain" class="main_remain">0.00</span></td>
												<?php
													foreach ($query as $row)
													{
												?>
														<td class="text-right" style="font-size:18px !important;"><span class="curr_remain" rate="<?=$row->rate?>" id="remain">0</span></td>
												<?php
													}
												?>
											</tr>
											<tr>
												<td  rowspan="2" width="50%" style="height: 50px; text-align:left;font-size:18px !important;"><?= lang("change"); ?></td>
											...
											<tr>
												<td class="text-right" style="font-size:18px !important;"><span id="change">0.00</span></td>
												<?php
												$this->db->select('*');
												$this->db->from('erp_currencies');
												$this->db->where('code != "USD" and in_out = 0');
												...
												if($pos_settings->in_out_rate == 1){
													...
													{
													?>
														<td class="text-right" style="font-size:18px !important;"><span class="curr_change" rate="<?=$row->rate?>" id="change">0</span></td>
													<?php
													}
												}else{
													foreach ($query as $row)
    ...
    $(document).ready(function () {
		...
		function autoCalremain(total_p){
            $(".curr_remain").each(function(){
                var rate = $(this).attr('rate');
				if(total_p != 0){
					$(this).html(formatMoney((parseFloat(total_p)*rate)));
				}else{
					$(this).html('0');
				}
            });
			$(".curr_remain_1").each(function(){
				...
				if(parseFloat(dot_cash) != 0){
					$(this).html(formatDecimal(formatMoney(parseFloat(dot_cash)*rate)));
				}else{
					$(this).html('0');
				}
            });
		...
		function autoCalchange(total_p){
			...
			$(".curr_change_1").each(function(){
				...
				var dot_cash = '0.'+str[1];
				if(parseFloat(dot_cash) != 0){
					$(this).html(formatMoney(parseFloat(dot_cash) * rate));
				}else{
					$(this).html('0');
				}
            });
...
//////////////
		...
		*/
		...
		$("#date,#date_receive").datetimepicker({
		...
		$("#date_receive").live('change keyup paste', function(){
			$(".date_receive").val($(this).val());
		});
...
$(document).ready(function(){
	...
	$('#ch_curr_payment').on('ifChanged', function() {
	  if ($(this).is(':checked')) {
		$('#curr_payment').val($(this).val());
	  }else{
		$('#curr_payment').val(0);
	  }
	});
