        ...
        <div class="modal-body">
            ...
            <div class="form-group">
			 ...
			 <div class="form-group">
                ...
                <div class="controls">
                    <?php 
					$type = array('1'=>lang("UNFinish_Good"),'0'=>lang("Finish_Good"));
					echo form_dropdown('cate_type', $type,  $category->jobs ,'id="cate_type" class="form-control select" " style="width:100%;" '); 
					?>
                </div>
            </div>
            <div class="form-group">
