                                ...
                                <div class="panel-body" style="padding: 5px;">
                                        <div class="col-md-4">
                                            <div class="form-group">
												...
												echo form_dropdown('group1', $gr1, '' ,'id="group1" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group1") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
												...
												echo form_dropdown('group2', $gr2, '' ,'id="group2" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group2") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
												...
												echo form_dropdown('group3', $gr3, '' ,'id="group3" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group3") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
												...
												echo form_dropdown('group4', $gr4, '' ,'id="group4" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group4") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
												...
												echo form_dropdown('group5', $gr5, '' ,'id="group5" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group5") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
                                    </div>									
