                        ...
                        <table class="table table-borderless table-striped dfTable table-right-left">
                            <tbody>
                                ...
                                <?php if ($Owner || $Admin) {
                                    ...
                                    echo '<tr><td>' . $this->lang->line("product_price") . '</td><td>' . $this->erp->formatMoney($product->price)."&nbsp;&nbsp;&nbsp;".'<span style="color:red !important;">'.$product->currentcy_code. '</span></td></tr>';
                                } else {
                ...
                <div class="col-xs-12">
                    <div class="row">
                        ...
                        <?php } ?>
							...
							<?php							
							if ($product->photowriter != 0 || $product->computer != 0  || $product->developphoto != 0 || $product->photographer != 0 || $product->studio_decor != 0 || $product->group1 != 0 || $product->group2 != 0 || $product->group3 != 0 || $product->group4 != 0 || $product->group5 != 0) { ?>
                            <h3 class="bold"><?= lang('commission') ?></h3>
                            <div class="table-responsive">
                                <table
                                class="table table-bordered table-striped table-condensed dfTable two-columns">
									<thead>
									...
									<tbody>
										...
										if ($product->photowriter != 0 ) {
											echo '<tr><td>' . lang("photowriter") . '</td><td>' . $this->erp->formatMoney($product->photowriter) . '</td></tr>';
										}
										if ($product->computer != 0) {
											echo '<tr><td>' . lang("computer") . '</td><td>' . $this->erp->formatMoney($product->computer) . '</td></tr>';
										}
										if ($product->developphoto != 0 ) {
											echo '<tr><td>' . lang("developphoto") . '</td><td>' . $this->erp->formatMoney($product->developphoto) . '</td></tr>';
										}
										if ($product->photographer != 0 ) {
											echo '<tr><td>' . lang("photographer") . '</td><td>' . $this->erp->formatMoney($product->photographer) . '</td></tr>';
										}
										if ($product->studio_decor != 0 ) {
											echo '<tr><td>' . lang("studio_decor") . '</td><td>' . $this->erp->formatMoney($product->studio_decor) . '</td></tr>';
										}
										if ($product->group1 != 0) {
											echo '<tr><td>' . lang("group1") . '</td><td>' . $this->erp->formatMoney($product->group1) . '</td></tr>';
										}
										if ($product->group2 != 0) {
											echo '<tr><td>' . lang("group2") . '</td><td>' . $this->erp->formatMoney($product->group2) . '</td></tr>';
										}
										if ($product->group3 != 0 ) {
											echo '<tr><td>' . lang("group3") . '</td><td>' . $this->erp->formatMoney($product->group3) . '</td></tr>';
										}
										if ($product->group4 != 0 ) {
											echo '<tr><td>' . lang("group4") . '</td><td>' . $this->erp->formatMoney($product->group4) . '</td></tr>';
										}
										if ($product->group5 != 0 ) {
											echo '<tr><td>' . lang("group5") . '</td><td>' . $this->erp->formatMoney($product->group5) . '</td></tr>';
										}
										?>
									</tbody>
								</table>
