            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="user"><?= lang("name_bom"); ?></label>
                                <?php
                                $boms[""] = "";
								if($bom == null){
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                <div
                                    class="panel-heading"><?= lang('created_by') ?></div>
                                <div class="panel-body" style="padding: 5px;">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $gr1 = array(""=>"");
												foreach($created_by as $group1){
													if($group1->name == 'group1'){
														$gr1[$group1->id] = $group1->first_name.' '.$group1->last_name;
													}
												}
												echo form_dropdown('group1', $gr1, $convert->group1 ,'id="group1" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group1") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $gr2 = array(""=>"");
												foreach($created_by as $group2){
													if($group2->name == 'group2'){
														$gr2[$group2->id] = $group2->first_name.' '.$group2->last_name;
													}
												}
												echo form_dropdown('group2', $gr2, $convert->group2 ,'id="group2" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group2") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $gr3 = array(""=>"");
												foreach($created_by as $group3){
													if($group3->name == 'group3'){
														$gr3[$group3->id] = $group3->first_name.' '.$group3->last_name;
													}
												}
												echo form_dropdown('group3', $gr3, $convert->group3 ,'id="group3" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group3") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $gr4 = array(""=>"");
												foreach($created_by as $group4){
													if($group4->name == 'group4'){
														$gr4[$group4->id] = $group4->first_name.' '.$group4->last_name;
													}
												}
												echo form_dropdown('group4', $gr4, $convert->group4 ,'id="group4" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group4") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $gr5 = array(""=>"");
												foreach($created_by as $group5){
													if($group5->name == 'group5'){
														$gr5[$group5->id] = $group5->first_name.' '.$group5->last_name;
													}
												}
												echo form_dropdown('group5', $gr5, $convert->group5 ,'id="group5" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("group5") . '" required="required" style="width:95%;" ');
                                                ?>
                                            </div>
                                        </div>
                                    </div>									
