        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
					...
					<div class="form-group">
                        <input name="cf" type="checkbox" class="checkbox" id="ch_commission"
                               value="" <?= isset($_POST['cf']) ? 'checked="checked"' : '' ?>/><label for="extras"
                                                                                                      class="padding05"><?= lang('commission') ?></label>
                    </div>
                    <div class="row" id="commission-con" style="display: none;">

                       <div class="col-md-4">
                            <div class="form-group all">
								<?= lang('photowriter', 'photowriter') ?>
                                <?= form_input('photowriter', (isset($_POST['photowriter']) ? $_POST['photowriter'] : ($product ? $this->erp->formatDecimal($product->photowriter) : '')), 'class="form-control tip" id="photowriter"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_input('computer', (isset($_POST['computer']) ? $_POST['computer'] : ($product ? $this->erp->formatDecimal($product->computer) : '')), 'class="form-control tip" id="computer"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_input('developphoto', (isset($_POST['developphoto']) ? $_POST['developphoto'] : ($product ? $this->erp->formatDecimal($product->developphoto) : '')), 'class="form-control tip" id="developphoto"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_input('photographer', (isset($_POST['photographer']) ? $_POST['photographer'] : ($product ? $this->erp->formatDecimal($product->photographer) : '')), 'class="form-control tip" id="photographer"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('studio_decor', 'studio_decor') ?>
                                <?= form_input('studio_decor', (isset($_POST['studio_decor']) ? $_POST['studio_decor'] : ($product ? $this->erp->formatDecimal($product->studio_decor) : '')), 'class="form-control tip" id="studio_decor"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('salesman', 'salesman') ?>
                                <?= form_input('salesman', (isset($_POST['salesman']) ? $_POST['salesman'] : ($product ? $this->erp->formatDecimal($product->salesman) : '')), 'class="form-control tip" id="salesman"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group1', 'group1') ?>
                                <?= form_input('group1', (isset($_POST['group1']) ? $_POST['group1'] : ($product ? $this->erp->formatDecimal($product->group1) : '')), 'class="form-control tip" id="group1"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group2', 'group2') ?>
                                <?= form_input('group2', (isset($_POST['group2']) ? $_POST['group2'] : ($product ? $this->erp->formatDecimal($product->group2) : '')), 'class="form-control tip" id="group2"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group3', 'group3') ?>
                                <?= form_input('group3', (isset($_POST['group3']) ? $_POST['group3'] : ($product ? $this->erp->formatDecimal($product->group3) : '')), 'class="form-control tip" id="group3"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group4', 'group4') ?>
                                <?= form_input('group4', (isset($_POST['group4']) ? $_POST['group4'] : ($product ? $this->erp->formatDecimal($product->group4) : '')), 'class="form-control tip" id="group4"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group5', 'group5') ?>
                                <?= form_input('group5', (isset($_POST['group5']) ? $_POST['group5'] : ($product ? $this->erp->formatDecimal($product->group5) : '')), 'class="form-control tip" id="group5"') ?>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		<?=isset($_POST['cf']) ? '$("#ch_commission").iCheck("check");': '' ?>
        $('#ch_commission').on('ifChecked', function () {
            $('#commission-con').slideDown();
        });
        $('#ch_commission').on('ifUnchecked', function () {
            $('#commission-con').slideUp();
        });
