            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row" id="extras-con" style="display: none;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('number_of_machine', 'number_of_machine') ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
								<?= lang('type_of_photo', 'type_of_photo') ?>
                    ...
                    <div class="row" id="commission-con" style="display: none;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_input('photowriter', (isset($_POST['photowriter']) ? $_POST['photowriter'] : ($product ? $product->photowriter : '')), 'class="form-control tip" id="photowriter"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_input('computer', (isset($_POST['computer']) ? $_POST['computer'] : ($product ? $product->computer : '')), 'class="form-control tip" id="computer"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_input('developphoto', (isset($_POST['developphoto']) ? $_POST['developphoto'] : ($product ? $product->developphoto : '')), 'class="form-control tip" id="developphoto"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_input('photographer', (isset($_POST['photographer']) ? $_POST['photographer'] : ($product ? $product->photographer : '')), 'class="form-control tip" id="photographer"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('studio_decor', 'studio_decor') ?>
                                <?= form_input('studio_decor', (isset($_POST['studio_decor']) ? $_POST['studio_decor'] : ($product ? $product->studio_decor : '')), 'class="form-control tip" id="studio_decor"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('salesman', 'salesman') ?>
                                <?= form_input('salesman', (isset($_POST['salesman']) ? $_POST['salesman'] : ($product ? $product->salesman : '')), 'class="form-control tip" id="salesman"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group1', 'group1') ?>
                                <?= form_input('group1', (isset($_POST['group1']) ? $_POST['group1'] : ($product ? $product->group1 : '')), 'class="form-control tip" id="group1"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group2', 'group2') ?>
                                <?= form_input('group2', (isset($_POST['group2']) ? $_POST['group2'] : ($product ? $product->group2 : '')), 'class="form-control tip" id="group2"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group3', 'group3') ?>
                                <?= form_input('group3', (isset($_POST['group3']) ? $_POST['group3'] : ($product ? $product->group3 : '')), 'class="form-control tip" id="group3"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group4', 'group4') ?>
                                <?= form_input('group4', (isset($_POST['group4']) ? $_POST['group4'] : ($product ? $product->group4 : '')), 'class="form-control tip" id="group4"') ?>
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('group5', 'group5') ?>
                                <?= form_input('group5', (isset($_POST['group5']) ? $_POST['group5'] : ($product ? $product->group5 : '')), 'class="form-control tip" id="group5"') ?>
                            </div>
                        </div>
                    </div>
