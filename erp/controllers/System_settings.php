...
class system_settings extends MY_Controller
{
    ...
    function edit_category($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
			...
			$data = array(
							...
							'jobs' =>$this->input->post('cate_type')
	...
	public function getListBom()
    {
        ...
        $detail_link = anchor('system_settings/bom_note/$1', '<i class="fa fa-file-text-o"></i> ' . lang('bom_note'), 'data-toggle="modal" data-target="#myModal2"');
